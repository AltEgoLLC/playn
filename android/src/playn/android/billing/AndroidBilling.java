...
import playn.android.billing.BillingService.RequestPurchase;
...
import playn.android.billing.BillingService.RestoreTransactions;
 ...
 * @author joey
 */
//public class AndroidBilling  extends Activity implements OnClickListener, OnItemSelectedListener{
 ...
 */
    ...
    private AndroidBillingPurchaseObserver mAndroidBillingPurchaseObserver;
...
//    private PurchaseDatabase mPurchaseDatabase;
     ...
     */
    private class AndroidBillingPurchaseObserver extends PurchaseObserver {
        public AndroidBillingPurchaseObserver(Handler handler) {
            super(mGameActivity, handler);
        }
...
//        mPurchaseDatabase = new PurchaseDatabase(context);
        ...
        ResponseHandler.register(mAndroidBillingPurchaseObserver);
        if (!mBillingService.checkBillingSupported()) {
            mGameActivity.showDialog(DIALOG_CANNOT_CONNECT_ID);
        }
...
//        super.onStop();
//        ResponseHandler.unregister(mAndroidBillingPurchaseObserver);
//    }
...
//        String helpUrl = replaceLanguageAndRegion(getString(6));
//        if (Consts.DEBUG) {
//            Log.i(TAG, helpUrl);
//        }
...
//            .setNegativeButton(7, new DialogInterface.OnClickListener() {
//                @Override
...
//            Toast.makeText(this, 0143, Toast.LENGTH_LONG).show();
//        }
    }
...
//        final View view = View.inflate(this, 33, null);
//        final TextView payloadText = (TextView) view.findViewById(33);
